...
const Skills = () => {
    ...
    const [skillsData, setSkillsData] = useState( [
        ...
        { id: 4, name: "CSS", description: " - Is a language for specifying how documents are presented to users", level: "20%" },
    ]);
    const [futureSkills, setFutureSkills] = useState( [
        { id: 5, name: "Parsing", description: " - Is converting data from one format to another", level: "10%" },
        { id: 6, name: "C#", description: " - Is the object-oriented high-level programming language", level: "5%" },
        { id: 7, name: "API", description: " - Is a set of rules or protocols that enables software applications to communicate with each other to exchange data, features and functionality", level: "5%" },
        { id: 8, name: "Machine Learning", description: " - Is the science of computer algorithms that help machines learn and improve from data analysis without explicit programming", level: "10%" },
        { id: 9, name: "Docker", description: " - Is a software platform that allows you to build, test, and deploy applications quickly", level: "0%" },
        { id: 10, name: "PHP", description: " - Is a widely-used, open source scripting language", level: "0%" },
        { id: 11, name: "Laravel", description: " - Is a web application framework with expressive, elegant syntax ", level: "0%" },
        { id: 12, name: "WordPress", description: " - Is open source software", level: "0%" },
    ]);
